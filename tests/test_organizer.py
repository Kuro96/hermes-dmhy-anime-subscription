...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("[Subs][Example Show][S02E03][1080p]", "Example Show/Season 02/Example Show - S02E03 - Subs [1080p].mkv"),
        ("[Subs][Example Show][Season 2 - 03][1080p]", "Example Show/Season 02/Example Show - S02E03 - Subs [1080p].mkv"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "[Subs][Example Show][Final Season - 03][1080p]",
        "[Subs][Example Show][Second Season - 03][1080p]",
        "[Subs][Example Show][OVA S02E03][1080p]",
        "[Subs][Example Show][S02E03 Bonus][1080p]",
        "[Subs][Example Show][Season 2 - 03 Bonus][1080p]",
        "[Subs][Example Show][S02E03][S02E04][1080p]",
